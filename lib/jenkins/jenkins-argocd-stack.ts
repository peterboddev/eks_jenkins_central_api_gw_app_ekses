...
/**
 * Jenkins ArgoCD Stack Props
 */
export interface JenkinsArgoCDStackProps extends cdk.StackProps {
  /**
...
/**
 * Jenkins ArgoCD Bootstrap Stack
 * 
 * This stack installs ArgoCD on the Jenkins EKS cluster using Helm.
 ...
 * 
 * Requirements: 1.1, 1.3, 1.4, 1.5, 1.6, 2.1-2.7
 */
    ...
    const argoCDIngress = props.cluster.addManifest('ArgoCDIngress', {
      ...
      metadata: {
        ...
        annotations: {
          ...
          'alb.ingress.kubernetes.io/load-balancer-name': 'jenkins-argocd-alb',
          
          // Security group for IP whitelisting
